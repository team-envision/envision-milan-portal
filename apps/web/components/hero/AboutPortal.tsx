...
export default function AboutPortal() {
  return (
    <section className="relative pt-24 pb-12 bg-gradient-to-b from-[#1B0B05] to-[#2D130A] overflow-hidden">
      ...
      {/* Decorative Image on Complete Right Side (Half Visible & Dull) */}
      {/* Added translate-x-1/2 to push it half off-screen right */}
      <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/3 hidden md:block pointer-events-none z-0">
        <Image 
          src="/images/elephant.png" 
          alt="Decorative Elephant" 
          width={400} 
          height={400}
          // Lowered opacity significantly and added grayscale for a dull look
